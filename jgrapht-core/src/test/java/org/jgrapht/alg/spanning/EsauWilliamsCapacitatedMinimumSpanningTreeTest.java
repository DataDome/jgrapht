...
public class EsauWilliamsCapacitatedMinimumSpanningTreeTest
{
    ...
    public void testInstance1()
    {
        ...
        assertEquals(
            cmst.getPartition().get(cmst.getLabels().get(2)), Pair.of(new HashSet<>(Arrays.asList(2, 5, 6)), 3.0));
        assertEquals(cmst.getPartition().get(cmst.getLabels().get(3)), Pair.of(new HashSet<>(Arrays.asList(3)), 2.0));
