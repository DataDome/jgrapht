...
public class BlossomVNodeTest
{
    ...
    public void testRemoveFromChildList()
    {
        ...
        assertEquals(new HashSet<>(Arrays.asList(node3)), BlossomVDebugger.getChildrenOf(node2));
        node3.removeFromChildList();
        assertEquals(empty, BlossomVDebugger.getChildrenOf(node2));

        assertEquals(new HashSet<>(Arrays.asList(node5)), BlossomVDebugger.getChildrenOf(node4));
        ...
        assertEquals(new HashSet<>(Arrays.asList(node2)), BlossomVDebugger.getChildrenOf(node1));
        ...
        assertEquals(new HashSet<>(Arrays.asList(node6)), BlossomVDebugger.getTreeRoots(state));
    ...
    public void testMoveChildrenTo()
    {
        ...
        assertEquals(new HashSet<>(Arrays.asList()), BlossomVDebugger.getChildrenOf(node3));
