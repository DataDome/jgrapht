...
public class BlossomVInitializerTest
{
    ...
    public void testGreedyInitialization()
    {
        ...
        assertEquals(new HashSet<>(Arrays.asList()), BlossomVDebugger.getTreeRoots(state));
        assertEquals(new HashSet<>(Arrays.asList(edge12)), BlossomVDebugger.getEdgesOf(node1));
        assertEquals(new HashSet<>(Arrays.asList(edge12)), BlossomVDebugger.getEdgesOf(node2));
    ...
    public void testSimpleInitialization()
    {
        ...
        assertEquals(new HashSet<>(Arrays.asList(edge23)), BlossomVDebugger.getEdgesOf(node3));
        assertEquals(new HashSet<>(Arrays.asList(edge45)), BlossomVDebugger.getEdgesOf(node4));
        assertEquals(new HashSet<>(Arrays.asList(edge25, edge45, edge56)), BlossomVDebugger.getEdgesOf(node5));
        assertEquals(new HashSet<>(Arrays.asList(edge56)), BlossomVDebugger.getEdgesOf(node6));
        assertEquals(new HashSet<>(Arrays.asList()), BlossomVDebugger.getEdgesOf(node7));
