...
public class SparseIntGraphTest
{
        ...
        BiFunction<Integer, List<Pair<Integer, Integer>>, Graph<Integer, Integer>> graphSupplier)
    {
        ...
        assertEquals(new HashSet<>(Arrays.asList()), g.incomingEdgesOf(2));
        ...
        assertEquals(new HashSet<>(Arrays.asList()), g.outgoingEdgesOf(6));
        ...
        assertEquals(new HashSet<>(Arrays.asList(0)), g.getAllEdges(0, 1));
        assertEquals(Integer.valueOf(1), g.getEdge(1, 0));
        assertEquals(new HashSet<>(Arrays.asList(1)), g.getAllEdges(1, 0));
        assertEquals(Integer.valueOf(2), g.getEdge(1, 4));
        assertEquals(new HashSet<>(Arrays.asList(2)), g.getAllEdges(1, 4));
        assertEquals(Integer.valueOf(3), g.getEdge(1, 5));
        assertEquals(new HashSet<>(Arrays.asList(3)), g.getAllEdges(1, 5));
        assertEquals(Integer.valueOf(4), g.getEdge(1, 6));
        assertEquals(new HashSet<>(Arrays.asList(4)), g.getAllEdges(1, 6));
        ...
        assertEquals(new HashSet<>(Arrays.asList(8)), g.getAllEdges(3, 4));
        assertEquals(Integer.valueOf(9), g.getEdge(4, 5));
        assertEquals(new HashSet<>(Arrays.asList(9)), g.getAllEdges(4, 5));
        assertEquals(Integer.valueOf(10), g.getEdge(5, 6));
        assertEquals(new HashSet<>(Arrays.asList(10)), g.getAllEdges(5, 6));
        assertEquals(Integer.valueOf(11), g.getEdge(7, 6));
        assertEquals(new HashSet<>(Arrays.asList(11)), g.getAllEdges(7, 6));
        assertEquals(Integer.valueOf(12), g.getEdge(7, 7));
        assertEquals(new HashSet<>(Arrays.asList(12)), g.getAllEdges(7, 7));
