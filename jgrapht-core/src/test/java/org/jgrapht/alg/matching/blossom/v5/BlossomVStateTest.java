...
public class BlossomVStateTest
{
    ...
    public void testMoveEdge()
    {
        ...
        assertEquals(new HashSet<>(Arrays.asList(edge23)), BlossomVDebugger.getEdgesOf(node2));
        ...
        assertEquals(new HashSet<>(Arrays.asList()), BlossomVDebugger.getEdgesOf(node2));
        assertEquals(new HashSet<>(Arrays.asList(edge12, edge13, edge23)), BlossomVDebugger.getEdgesOf(node3));
    }
