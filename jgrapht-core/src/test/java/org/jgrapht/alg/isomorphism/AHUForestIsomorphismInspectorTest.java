...
public class AHUForestIsomorphismInspectorTest
{
    ...
    public void testMissingSupplier()
    {
        ...
        AHUForestIsomorphismInspector<String, DefaultEdge> forestIsomorphism =
            new AHUForestIsomorphismInspector<>(tree1, new HashSet<>(Arrays.asList("1", "2")), tree1, new HashSet<>(Arrays.asList("1", "2")));
    ...
    public void testSmallForest()
    {
        ...
        AHUForestIsomorphismInspector<String, DefaultEdge> forestIsomorphism =
            new AHUForestIsomorphismInspector<>(tree1, new HashSet<>(Arrays.asList("b", "d")), tree2, new HashSet<>(Arrays.asList("A", "D")));
